...
postFormUrl = "https://europe-west1-test-firebase-1240d.cloudfunctions.net/testFormSubmit";
  ...
  const FormAbandonmentTracker2 = {
      ...
      onFieldChange: function(event) {
        ...
        this.$formHistory.push(parseInt(index));
      },
      ...
      sendEvents: function() {
        let lastQuestion = Math.max(...this.$formHistory);
        console.log("Last Question : ", lastQuestion);
        navigator.sendBeacon(postFormUrl, JSON.stringify({sheet: 1, data: [this.$date, lastQuestion]}));
      },
    };
